...
Write-Host "==> Creating virtual environment with Python 3.8.10..."
uv venv --python 3.8.10 $VenvPath
...
if ($pyVersion -ne "3.8.10") {
    throw "Unexpected Python version in venv: $pyVersion (expected 3.8.10)"
}
...
Write-Host "Activate with: .\.venv38\Scripts\Activate.ps1"
